        ...
        <section id="contact" className="py-16 md:py-24 px-4 relative overflow-hidden">
          ...
          <div className="container mx-auto text-center relative z-10">
            <div className="max-w-2xl mx-auto space-y-6 md:space-y-8">
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-display font-bold bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 bg-clip-text text-transparent animate-[scaleIn_0.5s_ease-out]">
                {t('readyToStart')}
              </h2>
              ...
              <Button 
                ...
                size="lg" 
                className="w-full sm:w-auto px-8 md:px-12 py-5 md:py-6 text-base md:text-lg rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-display font-semibold shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 transition-all duration-300"
              >
                {t('startNow')}
              </Button>
            </div>
      ...
      <footer className="relative border-t border-primary/10 py-8 md:py-12 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10 space-y-4 md:space-y-6">
          ...
          <div className="flex items-center justify-center gap-3 pt-2">
            <button onClick={() => window.open('mailto:vithalai2112@gmail.com', '_blank')}
              className="p-2 rounded-full bg-white/5 border border-white/10 hover:border-primary/25 hover:bg-primary/5 transition-all duration-300" aria-label="Email">
              <svg className="h-4 w-4 text-muted-foreground" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
              </svg>
            </button>
            <button onClick={() => window.open('https://www.instagram.com/vithal.ai', '_blank')}
              className="p-2 rounded-full bg-white/5 border border-white/10 hover:border-primary/25 hover:bg-primary/5 transition-all duration-300" aria-label="Instagram">
          ...
          {/* Sponsor */}
          <div className="pt-4 border-t border-primary/8 mt-4">
            <p className="text-xs text-foreground/50">
              Sponsored By{' '}
              <a href="https://www.instagram.com/shreealankar2112?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer"
