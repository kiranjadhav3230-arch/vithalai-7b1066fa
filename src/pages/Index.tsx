      ...
      <main className="relative">
        ...
        <footer className="relative border-t border-orange-500/20 py-12 md:py-16 overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10 space-y-6 md:space-y-8">
            <p className="text-base md:text-xl font-display text-foreground/90">© 2025 Vithal AI Assistant. Empowering Indian Professionals with Advanced AI-Driven Career Intelligence.{t('appName')}. {t('professionalDescription')}</p>
