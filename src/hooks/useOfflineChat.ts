...
export const useOfflineChat = (): UseOfflineChatReturn => {
  ...
  const downloadModel = useCallback(async () => {
    ...
    try {
      ...
      // Force single-threaded WASM to avoid SharedArrayBuffer/COOP+COEP issues
      // Let the library use default CDN paths for WASM assets
      try {
